...
- `projects/media-event-intelligence` — Inteligencia de eventos mediaticos | 668 articulos normalizados | 8 eventos | API + dashboard + contratos E2E
...
| `projects/media-event-intelligence` | NLP / Eventos | 668 articulos | 8 eventos | API + dashboard validado |
